...
public class TelemetriesController {
        ...
        public ResponseEntity<List<TelemetryRecordResource>> getTelemetryByDeviceId(
                        @RequestParam("device") String deviceId) {
                var query = new com.safecar.platform.workshop.domain.model.queries.GetTelemetryByDeviceIdQuery(
                                deviceId);
        ...
        public ResponseEntity<List<TelemetryRecordResource>> getTelemetryByVehicleAndRange(
                ...
                if (from != null && to != null) {
                        ...
                        var query = new com.safecar.platform.workshop.domain.model.queries.GetTelemetryByVehicleQuery(
                                        vehicle);
                        records = queryService.handle(query);
                }
