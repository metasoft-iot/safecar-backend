...
public class AppointmentsController {
        ...
        @Operation(summary = "Assign mechanic to appointment", description = "Assigns a specific mechanic to handle this appointment.")
        @ApiResponses(value = {
        ...
        /**
         * Unassign a specific mechanic from an appointment (RESTful endpoint with
         * validation).
         * Validates that the mechanicId in the URL matches the currently assigned
         * mechanic.
         */
        @DeleteMapping("/{appointmentId}/mechanics/{mechanicId}")
        @Operation(summary = "Unassign specific mechanic from appointment", description = "Removes a specific mechanic assignment from this appointment. Validates that the provided mechanicId matches the currently assigned mechanic.")
        @ApiResponses(value = {
