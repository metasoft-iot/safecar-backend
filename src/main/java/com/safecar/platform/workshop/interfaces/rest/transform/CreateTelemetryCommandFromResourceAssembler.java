...
public class CreateTelemetryCommandFromResourceAssembler {
    ...
    public static IngestTelemetrySampleCommand toCommandFromResource(CreateTelemetryResource resource) {
        ...
        VehicleId vehicleId = resource.vehicleId() != null ? new VehicleId(resource.vehicleId()) : null;
        DriverId driverId = resource.driverId() != null ? new DriverId(resource.driverId()) : null;
        ...
        return new IngestTelemetrySampleCommand(sample, resource.macAddress());
    }
